...
(function(tarsier) {
	...
	tarsier.String.prototype.convertTo = function(charset) {
		...
		// processing 'utf-16' string
		if (this.charset === "utf-16") {
			if (charset === "utf-8") {
				return utf16to8(this.data); // convert to 'utf-8'
			}
			if (charset === "base-64") {
				return base64encode(utf16to8(this.data)); // convert to 'base-64'
			}
		}
		...
		if (this.charset === "utf-8") {
			if (charset === "utf-16") {
				return utf8to16(this.data); // convert to 'utf-16'
			}
			if (charset === "base-64") {
				return base64encode(this.data); // convert to 'base-64'
			}
		}
		
		// processing 'base-64' string
		if (this.charset === "base-64") {
			if (charset === "utf-16") {
				return utf8to16(base64decode(this.data)); // convert to 'utf-16'
			}
			if (charset === "utf-8") {
				return base64decode(this.data); // convert to 'utf-8'
			}
		}
